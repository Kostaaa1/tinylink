...
func NewRedisTinylinkRepository(client *redis.Client) *RedisRepository {
...
func (r *RedisRepository) Save(ctx context.Context, tl *Tinylink, qp QueryParams) error {
...
func (r *RedisRepository) Get(ctx context.Context, qp QueryParams) (*Tinylink, error) {
...
func (r *RedisRepository) List(ctx context.Context, qp QueryParams) ([]*Tinylink, error) {
...
func (r *RedisRepository) Delete(ctx context.Context, qp QueryParams) error {
	pattern := fmt.Sprintf("client:%s:tinylink:%s", qp.ClientID, qp.Alias)
