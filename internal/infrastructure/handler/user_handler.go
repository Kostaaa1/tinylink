...
func (h UserHandler) HandleGoogleCallback(w http.ResponseWriter, r *http.Request) {
	...
	if err := writeJSON(w, http.StatusOK, envelope{"user": newUserDTO(loggedUser), "token": token}, nil); err != nil {
		h.ServerErrorResponse(w, r, err)
	}
}
...
func (h UserHandler) Login(w http.ResponseWriter, r *http.Request) {
	...
	if err := writeJSON(w, http.StatusOK, envelope{"user": newUserDTO(loggedUser), "token": accessToken}, nil); err != nil {
		h.ServerErrorResponse(w, r, err)
	}
}
...
func (h UserHandler) Register(w http.ResponseWriter, r *http.Request) {
	...
	if err := writeJSON(w, http.StatusOK, envelope{"user": newUserDTO(userData)}, nil); err != nil {
		h.ServerErrorResponse(w, r, err)
	}
}
